		...
		>
			...
			>
				{isMobile ? ( // Renderiza a versão animada apenas em dispositivos móveis
					...
					>
						<li>
							<Link className="underline" onClick={toggleMenu} to="/casas">
								casas
							</Link>
						</li>
						<li>
							<Link className="underline" onClick={toggleMenu} to="/comercial">
								comercial
							</Link>
						</li>
						<li>
							<Link className="underline" onClick={toggleMenu} to="/interiores">
								interiores
							</Link>
						</li>
						<li>
							<Link className="underline" onClick={toggleMenu} to="/edificios">
								edificios
							</Link>
						</li>
						<li>
							<Link className="underline" onClick={toggleMenu} to="/objetos">
								objetos
							</Link>
						</li>
					</motion.ul>
			...
			<button type="button" id="about" onClick={handleMarginOff}>
